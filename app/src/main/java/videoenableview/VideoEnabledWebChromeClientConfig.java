...
public class VideoEnabledWebChromeClientConfig {
    ...
    public static final class Builder {
         ...
         *
         * @param mOnCompletionListener the {@code mOnCompletionListener} to set
         ...
         *
         * @param mToggledFullscreenCallback the {@code mToggledFullscreenCallback} to set
         * @return a reference to this Builder
         */
         ...
         * methods can be chained together.
         *
         * @param mOnPreparedListener the {@code mOnPreparedListener} to set
         * @return a reference to this Builder
         */
         ...
         *
         * @param mOnErrorListener the {@code mOnErrorListener} to set
         * @return a reference to this Builder
         */
         ...
         * can be chained together.
         *
         * @param mNonVideoLayout the {@code mNonVideoLayout} to set
         * @return a reference to this Builder
         */
         ...
         * be chained together.
         *
         * @param mVideoLayout the {@code mVideoLayout} to set
         * @return a reference to this Builder
         */
         ...
         * chained together.
         *
         * @param mWebView the {@code mWebView} to set
         * @return a reference to this Builder
         */
         ...
         * be chained together.
         *
         * @param mLoadingView the {@code mLoadingView} to set
         * @return a reference to this Builder
         */
