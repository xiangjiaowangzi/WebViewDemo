...
import com.example.customweb.CusWebChromeClient;


public class InjectedChromeClient extends CusWebChromeClient {
    private final String TAG = "InjectedChromeClient";
    private JsCallJava mJsCallJava;
    private boolean mIsInjectedJS;

    public InjectedChromeClient(WebView webView, String injectedName, Class injectedCls) {
        super(webView);
        mJsCallJava = new JsCallJava(injectedName, injectedCls);
    }

    public InjectedChromeClient(WebView webView, JsCallJava jsCallJava) {
        super(webView);
